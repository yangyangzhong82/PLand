...
struct LegacyConfig;
using Config = LegacyConfig;

struct [[deprecated]] LegacyConfig {
    ...
    // Functions
    [[deprecated]] LDAPI static Config cfg;

    [[deprecated]] inline static constexpr std::string_view FileName = "Config.json";
